  ...
  const teamMembers = [
    {
      ...
      qualifications:
        "Dr. Mitchell holds a PhD in Biochemistry from Harvard University and maintains board certification in Clinical Research. Her academic foundation provides the scientific rigor essential for leading cutting-edge pharmaceutical research initiatives.",
      keyRoles:
    ...
    },
    {
      ...
      qualifications:
        "Dr. Chen earned his MD/PhD from Johns Hopkins University and is board certified in Internal Medicine. This unique combination of clinical practice and research expertise enables him to bridge the gap between laboratory discoveries and real-world patient applications.",
      keyRoles:
        "Dr. Chen oversees the entire spectrum of clinical trial operations, managing Phase I through Phase III studies with meticulous attention to patient safety and data integrity. He coordinates regulatory submissions and approvals across multiple international markets.",
      primaryColor: "orange",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1594824694996-f039b59cee77?w=500&h=500&fit=crop&crop=face",
      experience: "15 years in pharmaceutical regulatory compliance",
      qualifications:
        "Dr. Rodriguez holds a PharmD from the University of California and maintains Regulatory Affairs Certification (RAC). Her specialized training in pharmaceutical sciences and regulatory compliance ensures our products meet the most stringent safety and efficacy standards.",
      keyRoles:
        "Dr. Rodriguez ensures comprehensive FDA and international regulatory compliance across all our pharmaceutical operations. She manages complex drug approval processes and submissions, coordinating with global regulatory bodies to secure market authorization.",
      primaryColor: "rose",
    ...
    },
    {
      ...
      experience:
        "20 years in pharmaceutical manufacturing and quality control",
      qualifications:
        "Dr. Park earned his MS in Chemical Engineering from MIT and holds Six Sigma Black Belt Certification. His engineering background combined with lean manufacturing expertise drives operational excellence across our production facilities.",
      keyRoles:
        "Dr. Park oversees large-scale pharmaceutical production operations, ensuring efficient and cost-effective manufacturing while maintaining the highest quality standards. He implements Good Manufacturing Practice (GMP) standards and comprehensive quality systems.",
      primaryColor: "amber",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1622902046580-2b47f47f5471?w=500&h=500&fit=crop&crop=face",
      experience:
        "19 years in clinical medicine and pharmaceutical development",
      qualifications:
        "Dr. Williams holds an MD from Stanford Medical School and a Master's in Public Health from Johns Hopkins. She is board certified in Internal Medicine and Clinical Pharmacology, bringing deep clinical expertise to pharmaceutical development processes.",
      keyRoles:
        "As Chief Medical Officer, Dr. Williams leads our clinical strategy and medical affairs initiatives. She oversees patient safety protocols, clinical trial design, and works closely with healthcare providers to ensure our therapies meet real-world clinical needs and regulatory standards.",
      primaryColor: "blue",
      ...
      <div className="text-center py-16 px-4 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-rose-100 to-pink-100 rounded-full border border-rose-200 mb-8">
            ...
            <span className="text-rose-700 font-medium text-sm tracking-wide">
          ...
          <div className="mt-12">
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed font-light">
              ...
              <span className="font-semibold text-gray-800">
                distinguished pharmaceutical professionals
              </span>{" "}
              driving
              <span className="bg-gradient-to-r from-rose-600 to-pink-600 bg-clip-text text-transparent font-semibold">
                {" "}
                innovation
              </span>{" "}
              and
              ...
              in drug development across the globe.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="relative">
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-200 transition-all duration-500">
            <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
              ...
              <div
                className={`${currentMember.accentColor} p-10 flex flex-col justify-center items-center text-center relative overflow-hidden`}
              >
                ...
                <div className="relative z-10">
                  <div className="mb-8">
                    ...
                    />
                    <div
                      className={`inline-block px-6 py-2 ${currentMember.dotColor} rounded-full text-white text-sm font-medium mb-4`}
                    >
                  ...
                  <p
                    className={`text-xl font-semibold ${currentMember.textColor} mb-6`}
                  >
                    {currentMember.role}
                  </p>

                  <button
                    className={`${currentMember.buttonColor} text-white px-8 py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 shadow-lg`}
                  >
                    View Full Profile
                  </button>
                </div>
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    <div className="flex items-center mb-6">
                      <div
                        className={`p-3 ${currentMember.accentColor} rounded-xl mr-4`}
                      >
                        <svg
        ...
        <div className="flex justify-center mt-8 space-x-4">
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              {index === currentSlide && (
                <div
                  className={`absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-2 h-2 ${member.dotColor} rounded-full`}
                ></div>
              )}
            </button>
          ))}
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Dedicated professionals across all pharmaceutical disciplines
            </p>
          </div>
      ...
      <div className="bg-white py-16 border-t border-gray-200">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-xl text-gray-600 mb-10 leading-relaxed max-w-3xl mx-auto">
            Our leadership team brings together decades of experience in drug
            development, regulatory affairs, and clinical research to advance
            breakthrough therapies that transform lives.
          </p>
          <button
            onClick={() => navigate("/careers")}
            className="bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-700 hover:to-pink-700 text-white px-12 py-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
            Join Our Team
          </button>
        </div>
